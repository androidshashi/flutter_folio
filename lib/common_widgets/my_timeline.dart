...
class MyTimeLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Selector<HomeViewModel, List<ExperienceModel>>(
        ...
        builder: (context, myExperienceList, child) => Timeline.tileBuilder(
              ...
              builder: TimelineTileBuilder.fromStyle(
                ...
                contentsBuilder: (context, index) => Padding(
                  ...
                  child: Text(
                    "${myExperienceList[index].location},${myExperienceList[index].year}\n${myExperienceList[index].title}\n(${myExperienceList[index].company})",
                    style: titleTextStyle.copyWith(color: AppColor.primary),
                  ),
                ),
